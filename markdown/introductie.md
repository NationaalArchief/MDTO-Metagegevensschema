...
| gYear      | Periode van één kalenderjaar conform [ISO 8601](#iso-8601-2019).<br>Voorbeeld: 1993                                                                                                                                                                                                                                                                   |
| gYearMonth | Periode van één kalendermaand in een specifiek jaar conform [ISO 8601](#iso-8601-2019).<br>Voorbeeld: 2001-11 (November 2001)                                                                                                                                                                                                                         |
| dateTime   | Datum- en tijd uitgedrukt in YYYY-MM-DDThh:mm:ss conform [ISO 8601](#iso-8601-2019).<br>Voorbeeld: 2014-07-24T08:03:01 (24 juli 2014 8 uur, 3 minuten en 1 seconde)                                                                                                                                                                                   |
| duration   | Periode in tijd uitgedrukt conform  [ISO 8601](#iso-8601-2019).<br>Voorbeeld: P70Y (70 jaar), Of P0Y0M14D (14 dagen)                                                                                                                                                                                                                                  |
| anyURI     | URI conform RFC 3987. URI staat voor Uniform Resource Identifier (zie [Wikipedia](#uri-wikipedia)). Het is een gestandaardiseerde manier om te verwijzen naar een stuk data (zoals webpagina’s met informatie, objecten en datasets) en hier direct toegang toe te geven. Een URL is een voorbeeld van een URI.<br>Voorbeeld: https://www.example.com |
| language   | Identificatiekenmerk van een natuurlijk taal conform [RFC 3066](#rfc-3066).<br>Voorbeeld: nl (Nederland)                                                                                                                                                                                                                                              |
...
| integer    | Geheel getal, lengte is minimaal 1 en maximale lengte is onbepaald, zonder voorloopnullen. Subtype van ISO Number (ISO 11404) (zie [ISO/IEC 11404](#iso-11404)).<br>Voorbeeld: 23042                                                                                                                                                                  |
