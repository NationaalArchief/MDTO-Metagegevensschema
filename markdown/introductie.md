...
- [Bestand](#bestand): Een geordende verzameling van gegevens in elektronische vorm, die door een elektronisch apparaat onder één naam kan worden behandeld en aangesproken. Zoals een Word-bestand of MPEG-bestand. Zie ook de [definitie van Bestand](https://www.nationaalarchief.nl/archiveren/kennisbank/computerbestand).
- [Bedrijfsactiviteit](#bedrijfsactiviteit): een taak die wordt uitgevoerd door een organisatie (Bron: [NEN-ISO 30300:2020](https://www.nen.nl/nen-iso-30300-2020-en-271394)). Zie ook de specificatie van [Bedrijfsactiviteit](#bedrijfsactiviteit).
- [Actor](#actor): Persoon, groep, organisatie of functionaris. Zie ook de specificatie van [Actor](#actor).
- [Locatie](#locatie): Fysieke plaats in de ruimte. Zie ook de specificatie van [Locatie](#locatie).

In het onderstaande diagram zijn de in MDTO gespecificeerde relaties tussen de verschillende objecten weergegeven:

![MDTO relaties tussen de verschillende objecten](images/diagram.png)
...
### Enkelvoudig gegeven
Een enkelvoudig gegeven is een gegeven dat binnen MDTO niet verder gestructureerd is. De enkelvoudig gegevens vormen de basis van de metagegevens. De enkelvoudige gegevens in  MDTO hebben de vorm van een XML built-in datatype (zie [XML Schema Part 2: Datatypes](https://www.w3.org/TR/xmlschema-2/)). Bijvoorbeeld:
...
Zie de specificatie van de gegevensgroepklasse [verwijzingGegevens](#verwijzingsgegevens) en de bijbehorende attributen voor de volledige beschrijving.
...
Zie de specificatie van de gegevensgroepklasse [begripGegevens](#begripgegevens) en de bijbehorende attributen voor de volledige beschrijving. 
...
| ------------ | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Naam         | De naam van de klasse. Deze wordt gebruikt om naar de klasse te verwijzen. De naam is een tekenreeks zonder spaties. Voor objectklassen wordt de naamgevingsconventie [UpperCamelCase](https://nl.wikipedia.org/wiki/CamelCase) gebruikt. |
...
| Onderdelen     | Beschrijving                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     |
| -------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| Naam           | De naam van het attribuut. Deze wordt gebruikt om naar het attribuut te verwijzen. De naam is een tekenreeks zonder spaties. Voor attributen wordt de naamgevingsconventie [lowerCamelCase](https://nl.wikipedia.org/wiki/CamelCase) gebruikt.                                                                                                                                                                                                                                                                                                                                                   |
...
| Doel           | Waarom het van belang is om dit attribuut op te nemen in metagegevens. Vanuit het perspectief van [duurzame toegankelijkheid](https://www.nationaalarchief.nl/archiveren/kennisbank/wat-betekent-archiveren). Bij de attributen van een gegevensgroep wordt geen doel vermeld.                                                                                                                                                                                                                                                                                                                   |
...
Alle  datatypen zijn ingebouwde (built-in) datatypen gedefinieerd in [XML Schema](https://www.w3.org/TR/xmlschema-2/).

| Naam       | Toelichting                                                                                                                                                                                                                                                                                                                                                                     |
| ---------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| date       | Datum uitgedrukt als YYYY-MM-DD conform [ISO 8601](https://www.iso.org/standard/70907.html). <br>Voorbeeld: 1976-06-13 (13 juni 1976)                                                                                                                                                                                                                                           |
| gYear      | Periode van één kalenderjaar conform [ISO 8601](https://www.iso.org/standard/70907.html).<br>Voorbeeld: 1993                                                                                                                                                                                                                                                                    |
| gYearMonth | Periode van één kalendermaand in een specifiek jaar conform [ISO 8601](https://www.iso.org/standard/70907.html).<br>Voorbeeld: 2001-11 (November 2001)                                                                                                                                                                                                                          |
| dateTime   | Datum- en tijd uitgedrukt in YYYY-MM-DDThh:mm:ss conform [ISO 8601](https://www.iso.org/standard/70907.html).<br>Voorbeeld: 2014-07-24T08:03:01 (24 juli 2014 8 uur, 3 minuten en 1 seconde)                                                                                                                                                                                    |
| duration   | Periode in tijd uitgedrukt conform  [ISO 8601](https://www.iso.org/standard/70907.html).<br>Voorbeeld: P70Y (70 jaar), Of P0Y0M14D (14 dagen)                                                                                                                                                                                                                                   |
| anyURI     | URI conform RFC 3987. URI staat voor [Unique Resource Identifier](https://nl.wikipedia.org/wiki/Uniform_resource_identifier). Het is een gestandaardiseerde manier om te verwijzen naar een stuk data (zoals webpagina’s met informatie, objecten en datasets) en hier direct toegang toe te geven. Een URL is een voorbeeld van een URI.<br>Voorbeeld: https://www.example.com |
| language   | Identificatiekenmerk van een natuurlijk taal conform [RFC 3066](https://www.ietf.org/rfc/rfc3066.txt).<br>Voorbeeld: nl (Nederland)                                                                                                                                                                                                                                             |
| string     | Een reeks tekens of karakters. Een lege string wordt opgevat als een ontbrekende waarde. In MDTO zijn lege strings daarom niet toegestaan.<br>Voorbeeld: “abc 123”                                                                                                                                                                                                              |
| integer    | Geheel getal, lengte is minimaal 1 en maximale lengte is onbepaald, zonder voorloopnullen. Subtype van ISO Number (ISO 11404) (zie [ISO/IEC 11404](https://www.nen.nl/nen-iso-iec-11404-2008-en-122652)).<br>Voorbeeld: 23042                                                                                                                                                   |