...
Beschikbaar via: https://www.iso.org/standard/70907.html

<span id="iso-11404"></span>
**ISO.** (1996). *ISO/IEC 11404:1996 – Information technology — Programming languages, their environments and system software interfaces — Language-independent datatypes*. Genève: ISO.  
Beschikbaar via: https://www.iso.org/standard/19245.html

<span id="rfc-3066"></span>
**IETF.** (2001). *RFC 3066 – Tags for the Identification of Languages*.  
Beschikbaar via: https://www.ietf.org/rfc/rfc3066.txt

<span id="uri-wikipedia"></span>
**Wikipedia.** (z.d.). *Uniform Resource Identifier*.  
Beschikbaar via: https://nl.wikipedia.org/wiki/Uniform_resource_identifier